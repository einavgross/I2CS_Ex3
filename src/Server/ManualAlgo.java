...
public class ManualAlgo implements PacManAlgo{
     ...
     * 4. You are asked to implement the following classes: Shapes.Index2D, Shapes.Map, Client.Ex3Algo.
    ...
    public static class Ex3Main {
        ...
        public static void play1() {
            ...
            while (ex3.getStatus() != PacmanGame.DONE) {
                ...
                if (_cmd != null && _cmd == 'h') {
                    IO.println("Pacman help: keys: ' '-start, 'w,a,s,d'-directions, all other parameters should be configured via Client.GameInfo.java, ");
                }
